...
public class AuthController {
    ...
    public String onlyModerador(Authentication authentication) {return "Moderador: " + authentication.getName();}

    // Qualquer um irá acessar
    @GetMapping("/comum")
    public String getComum(Authentication authentication){return "Usuário Comum: " + authentication.getName();}
}
